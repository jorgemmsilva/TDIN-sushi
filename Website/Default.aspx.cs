...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        orderObj.writeToConsole("here: " + sushicount.ToString());
    ...
    */
    ...
    protected void addSushiChoice(object sender, EventArgs e)
    {
        ...
        ++sushicount;
        orderObj.writeToConsole("ACRESCENTA AI CARAI" + sushicount);
      ...
      * */
        //oldhtml.Add(sushichoices.InnerHtml);
        //sushichoices.InnerHtml += oldhtml.First() + "<asp:Button class=\"removesushichoice\" text=\"+\" OnClick=\"removeSushiChoice\" runat=\"server\"/>";
    }
    ...
    protected void removeSushiChoice(object sender, EventArgs e)
    {
        ...
        orderObj.writeToConsole("TIRA AI CARAI" + sushicount);
        //sushichoices.InnerHtml = oldhtml.Last();
        //oldhtml.Remove(oldhtml.Last());
    }
}